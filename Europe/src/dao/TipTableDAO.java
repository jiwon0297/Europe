...
// select(find/get) number 검색(글 불러오기)
	public TipElementBean select(Connection conn, int number) throws SQLException {
		...
		public List<TipElementBean> titleselect(Connection conn, String title) throws SQLException {
			PreparedStatement pstmt = null;
			ResultSet rs = null;
			try {
		...
		public List<TipElementBean> writerselect(Connection conn, String name) throws SQLException {
			PreparedStatement pstmt = null;
			ResultSet rs = null;
			try {
