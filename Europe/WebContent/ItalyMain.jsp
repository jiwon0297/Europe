...
<section id="portfolio" class="portfolio sections">
                <div class="container">
                        ...
                        <div class="main_portfolio">
                            <div class="col-sm-12">
                                <div class="head_title text-center">
                                    <a href="ItalyMain.jsp" style="color:white;"><h2>Italy</h2></a>
                                    <div class="subtitle" style="color:white;">
                                        Choose the category what you want.
                                    </div>
                                    <div class="separator"></div>
                                    <div><img src="resources/assets/images/italy.PNG" style="width:800px; height:500px"></div>
                                </div>
                            </div>
                            </div>
                    ...
                    <div class="row">
						...
						<a href="ItalyInfoListViewAction.do" style="color:white">
                            <div class="col-sm-3">
                            ...
                            <a href="ItalyMarketListViewAction.do" style="color:white">
                            <div class="col-sm-3">
                                <div class="single_feature">
                                    <div class="single_feature_icon">
                            ...
                            <a href="ItalyTogethersListViewAction.do" style="color:white;">
                            <div class="col-sm-3">
                                <div class="single_feature">
                                    <div class="single_feature_icon">
