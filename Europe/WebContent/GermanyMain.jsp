...
<body>
    ...
    <!--top place start-->
    <section class="event_part section_padding" style="background-image: url('marine/img/Germany.jpg'); background-size:cover; height:560px;">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
    ...
    <!--::industries start::-->
    <section class="hotel_list section_padding" style="background-color:#76844c;">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6">
                    <div class="section_tittle text-center">
                        <h2 style="font-size:50pt; margin-top:-80px; color:white">Germany</h2>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-sm-6">
                    <div class="single_ihotel_list">
                        <a href="GermanyInformationListViewAction.do"><img src="marine/img/information.jpg" alt=""></a>
                        <div class="hotel_text_iner">
                            <h3 style="font-size:23pt;"><a href="GermanyInfoListViewAction.do" style="color:white"> Travel Information</a></h3>
                            <p style="font-size:13pt; color:#cbd8a0;">You can share your experience and you can get the information, too</p><br>
							<a href="GermanyInformationListViewAction.do"style="color:#ff5e00"><h5 style="text-align:right; font-size:13pt;">>> Detail</h5></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="single_ihotel_list">
                        <a href="GermanyMarketListViewAction.do"><img src="marine/img/market.jpg" alt=""></a>
                        <div class="hotel_text_iner">
                            <h3 style="font-size:23pt;"><a href="GermanyMarketListViewAction.do" style="color:white"> Market</a></h3>
                            <p style="font-size:13pt; color:#cbd8a0;">You can exchange your USIM, money etc. you can buy or sell, too.</p><br>
							<a href="GermanyMarketListViewAction.do"style="color:#ff5e00"><h5 style="text-align:right; font-size:13pt;">>> Detail</h5></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="single_ihotel_list">
                        <a href="GermanyTogetherListViewAction.do"><img src="marine/img/together.jpg" alt=""></a>
                        <div class="hotel_text_iner">
                            <h3 style="font-size:23pt;"><a href="GermanyTogetherListViewAction.do" style="color:white"> Together</a></h3>
                            <p style="font-size:13pt; color:#cbd8a0;">You can find the traveler. And you can trip and eat with them.</p><br>
							<a href="GermanyTogetherListViewAction.do" style="color:#ff5e00"><h5 style="text-align:right; font-size:13pt;">>> Detail</h5></a>
                        </div>
                    </div>
                </div>
            </div>
        </div>
         <div style="position: relative; left:95px; background-color:#76844c;"><jsp:include page="country.jsp"/></div>
    </section>
    <!--::industries end::-->
