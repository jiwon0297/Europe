...
<div style="background-image: url('./resource/main.png'); width:100%;height:230px;">
	<br><br>
	<h1><strong>SINGER등록하기</strong></h1>
</div><br><br>
	<div class="container">
		<form name="addSinger" action="AddSingerElementAction.do" method="post">		
			...
			<div class="col-sm-3">
			<input type="text" name="kind" class="form-control" value="SINGER라고 입력해주세요">
			</div>
			</div>
