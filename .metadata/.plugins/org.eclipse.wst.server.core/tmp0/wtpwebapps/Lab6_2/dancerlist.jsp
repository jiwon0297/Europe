...
<%@ page import="dao.DancerTableDAO" %>
<%@ page import="dto.DancerElementBean" %>
...
<title>dancerList</title>
</head>
<body>
<script type ="text/javascript">
	function deleteConfirm(number){
		if(confirm("Do you want to remove?") == true)
			location.href="DeleteDancerAction.do?number=" + number;
		else
				return;
	}
</script>
...
<div style="background-image: url('./resource/main.png'); width:100%;height:230px;">
	<br><br>
	<h1><strong>등록된 DANCER의 목록입니다.</strong></h1>
</div>
<br>
<nav id="header" >
		<ul>
                   <li><a class="link" href="AddDancerAction.do">Add</a></li>
       </ul>      
</nav>
<table>
	<tr>
		...
		<c:forEach var="pe" items="${pList}">
			<tr>
				...
				<td>
					...
					<p><a href="EditDancerAction.do?number=${pe.getNumber()}" class="btn btn-secondary" role="button">edit &raquo; </a>
